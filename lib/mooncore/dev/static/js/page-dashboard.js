    ...
    <div class="${wrapperClass}" style=${wrapperStyle}>
      <div class="flex items-start gap-3">
        ...
        <div class="space-y-1">
          ...
          <div class="text-xs leading-relaxed">The application has not configured <code>dev_tools_allowed_ips</code>. Without an IP allowlist, dev tools will accept requests from any IP. Restrict access by setting <code>dev_tools_allowed_ips</code> or disable dev tools in production.</div>
        </div>
      </div>
    </div>
  `}
